...
import com.nishchay.ds.array.a05merge.MergeTwoSortedArray;
...
public class MergeKSortedArrays {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("mergeSortedMatrix_merging(mat) = " + mergeSortedMatrix_merging(mat));
    ...
    private static void heapEx() {
        ...
        ArrayList<Integer> mergedAscendingOrderData = mergeSortedMatrix_heap(data);
     ...
     * Auxiliary Space: O(n)
     * */
    private static List<Integer> mergeSortedMatrix_sorting(int[][] mat) {
     ...
     *
     * Time complexity: O(c * r²) + n, where r rows and c columns
     *                  O(N * r)   (since N = r*c)
     ...
     *
     * */
    public static List<Integer> mergeSortedMatrix_merging(int[][] mat) {
     ...
     * Auxiliary Space: O(k)
     * */
    static ArrayList<Integer> mergeSortedMatrix_heap(int[][] mat) {
        int k = mat.length;
